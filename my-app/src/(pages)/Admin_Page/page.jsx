...
import { Box, Container, Typography, Button, Card, CardActionArea, CardMedia, CardContent, Chip, IconButton } from "@mui/material";
...
export default function AdminPage() {
  ...
  const onDelete = async (e, id) => {
    e.stopPropagation(); // ไม่ให้ลิงก์เข้า edit
              ...
              <CardActionArea onClick={() => nav(`/admin/product/${p._id}`)}>
                ...
                <CardContent>
                  ...
                  <Box sx={{ display: "flex", justifyContent: "space-between", mt: .5 }}>
                    ...
                    <Typography color="text.secondary">{Number(p.price || 0).toLocaleString()} ฿</Typography>
                  </Box>
                </CardContent>
              </CardActionArea>
            </Card>
